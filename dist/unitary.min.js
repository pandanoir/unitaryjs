var __extends=this&&this.__extends||function(c,b){function a(){this.constructor=c}for(var e in b)b.hasOwnProperty(e)&&(c[e]=b[e]);c.prototype=null===b?Object.create(b):(a.prototype=b.prototype,new a)};function gcd(c,b){return c<b?gcd(b,c):0>c?gcd(-c,b):0>b?gcd(c,-b):0===b?c:gcd(b,c%b)}
...
return this};c.prototype.move=function(b,a){return this};c.prototype.moveX=function(b){return this.move(b,0)};c.prototype.moveY=function(b){return this.move(0,b)};c.prototype.has=function(b){return!1};c.prototype.name=function(){return"UnitaryObject"};return c}();exports.UnitaryObject=UnitaryObject;
...
-this.center.x);a+=")^2+(y";0<this.center.y?a+="-"+this.center.y:0>this.center.y&&(a+="+"+-this.center.y);return a+=")^2="+this.r+"^2"};b.prototype.equals=function(a){return c.prototype.equals.call(this,a)?this.center.equals(a.center)&&this.r===a.r:!1};b.prototype.has=function(a){return(new Vector(a)).substract(new Vector(this.center)).abs()<=this.r};b.prototype.name=function(){return"Circle"};return b}(UnitaryObject);exports.Circle=Circle;
...
b.prototype.rotate=function(a){return(new b(this.center,this.r,this.endAngle+a,this.startAngle+a)).setStyle(this.style)};b.prototype.equals=function(a){return c.prototype.equals.call(this,a)?this.center.equals(a.center)&&this.r===a.r&&0===(this.startAngle-a.startAngle)%(2*Math.PI)&&0===(this.endAngle-a.endAngle)%(2*Math.PI):!1};b.prototype.has=function(a){var b=Math.atan2(a.y,a.x);return(new Vector(a)).substract(new Vector(this.center)).abs()<=this.r&&this.startAngle<=b&&b<=this.endAngle};b.prototype.name=
...
a.y),b=new Vector(b.x,b.y),d=new Vector(d.x,d.y),l=Math.pow(f.length,2),m=Math.pow(g.length,2),n=Math.pow(c.length,2),k=(new Vector(0,0)).add(a.multiple(l*(m+n-l))).add(b.multiple(m*(n+l-m))).add(d.multiple(n*(l+m-n))).multiple(1/(16*Math.pow(k,2))),k=new Point(k.x,k.y),c=b.substract(a).product(d.substract(a))/(c.length*g.length);return new Circle(k,f.length/Math.sqrt(1-Math.pow(c,2))/2)};b.prototype.getIncircle=function(){var a=new Vector(this.points[0].x,this.points[0].y),b=new Vector(this.points[1].x,
...
this.points[1],d=this.points[2],c=new Segment(a,b),f=new Segment(a,d),b=new Vector(b.x-a.x,b.y-a.y),a=new Vector(d.x-a.x,d.y-a.y),a=b.product(a)/(c.length*f.length);return c.length*f.length*Math.sqrt(1-Math.pow(a,2))/2};b.prototype.move=function(a,e){var d=c.prototype.move.call(this,a,e);return new b(d.points[0],d.points[1],d.points[2])};b.prototype.rotate=function(a,e){"undefined"===typeof e&&(e=this.getCenter());var d=c.prototype.rotate.call(this,a,e);return new b(d.points[0],d.points[1],d.points[2])};
...
function(){return"Image"};return b}(UnitaryObject);exports.Image=Image;var Group=function(c){function b(){c.call(this);for(var a=[],b=0,d=arguments.length;b<d;b++)a[b]=arguments[b];"[object Array]"===Object.prototype.toString.call(a[0])?this.group=a[0]:this.group=a}__extends(b,c);b.prototype.has=function(a){for(var b=0,c=this.group.length;b<c;b++)if(this.group[b].has&&this.group[b].has(a))return!0;return!1};b.prototype.name=function(){return"Group"};return b}(UnitaryObject);exports.Group=Group;
var Graph=function(c){function b(a,b){c.call(this);this.f=a;this.scale=b;this.end=this.start=null}__extends(b,c);b.prototype.setRange=function(a,b){this.start=a;this.end=b;return this};b.prototype.equals=function(){return!1};b.prototype.moveX=function(){};b.prototype.moveY=function(){};b.prototype.name=function(){return"Graph"};return b}(UnitaryObject);exports.Graph=Graph;exports.XAxis=new Line(new Point(0,0),new Point(1,0));exports.YAxis=new Line(new Point(0,0),new Point(0,1));exports.VERSION="0.0.6";
