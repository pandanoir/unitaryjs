...
var Circle=function(c){function b(a,e){if(!(this instanceof b))throw Error("Constructor cannot be called as a function.");c.call(this);this.Origin=a;this.r=e}__extends(b,c);b.prototype.moveTo=function(a,e){return(new b(this.Origin.moveTo(a,e),this.r)).setStyle(this.style)};b.prototype.move=function(a,e){return(new b(this.Origin.move(a,e),this.r)).setStyle(this.style)};b.prototype.getEquation=function(){var a="(x";0<this.Origin.x?a+="-"+this.Origin.x:0>this.Origin.x&&(a+="+"+-this.Origin.x);a+=")^2+(y";
0<this.Origin.y?a+="-"+this.Origin.y:0>this.Origin.y&&(a+="+"+-this.Origin.y);return a+=")^2="+this.r+"^2"};b.prototype.equals=function(a){return c.prototype.equals.call(this,a)?this.Origin.equals(a.Origin)&&this.r===a.r:!1};b.prototype.name=function(){return"Circle"};return b}(UnitaryObject);exports.Circle=Circle;
var CircularSector=function(c){function b(a,e,d,g){void 0===g&&(g=0);if(!(this instanceof b))throw Error("Constructor cannot be called as a function.");c.call(this);this.center=a;this.r=this.radius=e;this.endAngle=d;this.startAngle=g}__extends(b,c);b.prototype.moveTo=function(a,e){return(new b(this.center.moveTo(a,e),this.r,this.endAngle,this.startAngle)).setStyle(this.style)};b.prototype.move=function(a,e){return(new b(this.center.move(a,e),this.r,this.endAngle,this.startAngle)).setStyle(this.style)};
...
function(a,e){for(var d=[],c=0,f=this.points.length;c<f;c++)d[c]=this.points[c].rotate(a,e);return(new b(d)).setStyle(this.style)};b.prototype.has=function(a){var b,d,c;d=this.points[this.points.length-1];for(var f=0,h=0,k=this.points.length;h<k;h++)c=this.points[h],b=(new Vector(c)).substract(new Vector(a)),d=(new Vector(d)).substract(new Vector(a)),b=b.product(d)/(b.abs()*d.abs()),f+=Math.acos(b),d=c;return 360===Math.round(f/(2*Math.PI)*360)};b.prototype.name=function(){return"Polygon"};return b}(UnitaryObject);
exports.Polygon=Polygon;
var Quadrilateral=function(c){function b(a,e,d,g){if(!(this instanceof b))throw Error("Constructor cannot be called as a function.");if((new Segment(a,g)).intersects(new Segment(e,d)))throw Error("ABCD is not a quadrilateral.");if(a.equals(e)||a.equals(d)||a.equals(g)||e.equals(d)||e.equals(g)||d.equals(g))throw Error("ABCD is not a quadrilateral.");c.call(this,a,e,d,g)}__extends(b,c);b.prototype.getArea=function(){var a=this.points[0],b=this.points[2],d=this.points[3],c=(new Triangle(a,this.points[1],
...
var Triangle=function(c){function b(a,e,d){if(!(this instanceof b))throw Error("Constructor cannot be called as a function.");if(null==a||null==e||null==d)throw Error("Triangle must have three vertices.");if(a.equals(e)||e.equals(d)||a.equals(d))throw Error("Triangle must have three vertices.");c.call(this,a,e,d)}__extends(b,c);b.prototype.getCircumcircle=function(){var a=this.points[0],b=this.points[1],d=this.points[2],c=new Segment(a,b),f=new Segment(b,d),h=new Segment(d,a),k=this.getArea(),a=new Vector(a.x,
a.y),b=new Vector(b.x,b.y),d=new Vector(d.x,d.y),l=Math.pow(f.length,2),m=Math.pow(h.length,2),n=Math.pow(c.length,2),k=(new Vector(0,0)).add(a.multiple(l*(m+n-l))).add(b.multiple(m*(n+l-m))).add(d.multiple(n*(l+m-n))).multiple(1/(16*Math.pow(k,2))),k=new Point(k.x,k.y),c=b.substract(a).product(d.substract(a))/(c.length*h.length),c=Math.sqrt(1-Math.pow(c,2));return new Circle(k,f.length/c/2)};b.prototype.getIncircle=function(){var a=new Vector(this.points[0].x,this.points[0].y),b=new Vector(this.points[1].x,
this.points[1].y),d=new Vector(this.points[2].x,this.points[2].y),c=d.substract(b).abs(),f=d.substract(a).abs(),h=b.substract(a).abs(),a=(new Vector(0,0)).add(a.multiple(c/(c+f+h))).add(b.multiple(f/(c+f+h))).add(d.multiple(h/(c+f+h))),a=new Point(a.x,a.y),c=2*this.getArea()/(c+f+h);return new Circle(a,c)};b.prototype.getCenter=function(){var a=this.points[0],b=this.points[1],c=this.points[2];return new Point((a.x+b.x+c.x)/3,(a.y+b.y+c.y)/3)};b.prototype.getArea=function(){var a=this.points[0],b=
this.points[1],c=this.points[2],g=new Segment(a,b),f=new Segment(a,c),b=new Vector(b.x-a.x,b.y-a.y),a=new Vector(c.x-a.x,c.y-a.y),a=b.product(a)/(g.length*f.length),a=Math.sqrt(1-Math.pow(a,2));return g.length*f.length*a/2};b.prototype.move=function(a,e){var d=c.prototype.move.call(this,a,e);return new b(d.points[0],d.points[1],d.points[2])};b.prototype.rotate=function(a,e){"undefined"===typeof e&&(e=this.getCenter());var d=c.prototype.rotate.call(this,a,e);return new b(d.points[0],d.points[1],d.points[2])};
...
var Text=function(c){function b(a,e,d,g){void 0===d&&(d="left");void 0===g&&(g=null);if(!(this instanceof b))throw Error("Constructor cannot be called as a function.");c.call(this);this.P=e;this.text=this.string=a;this.strokesOutline=!1;this.style.align=d;this.style.maxWidth=g;this.style.fillColor="#000";this.style.outlineColor="#000";this.style.baseline="alphabetic";this.style.font=null}__extends(b,c);b.prototype.strokeOutline=function(){this.strokesOutline=!0;return this};b.prototype.setAlign=function(a){this.style.align=
...
var Image=function(c){function b(a,e){if(!(this instanceof b))throw Error("Constructor cannot be called as a function.");c.call(this);this.src=a;this.startPoint=e;this.dx=e.x;this.dy=e.y;this.sy=this.sx=this.sh=this.sw=this.dh=this.dw=null}__extends(b,c);b.prototype.trim=function(a,b,c,g,f){void 0===g&&(g=null);void 0===f&&(f=null);null==g&&(g=b);null==f&&(f=c);this.sx=a.x;this.sy=a.y;this.sw=b;this.sh=c;this.dw=g;this.dh=f;return this};b.prototype.resize=function(a,b){this.dw=a;this.dh=b;return this};
b.prototype.equals=function(a){return c.prototype.equals.call(this,a)?this.src===a.src&&this.dx===a.dx&&this.dy===a.dy&&this.dw===a.dw&&this.dh===a.dh&&this.sw===a.sw&&this.sh===a.sh&&this.sx===a.sx&&this.sy===a.sy:!1};b.prototype.move=function(a,c){var d=new b(this.src,this.startPoint.move(a,c));null!==this.sx&&d.trim(new Point(this.sx,this.sy),this.sw,this.sh,this.dw,this.dh);return d};b.prototype.name=function(){return"Image"};return b}(UnitaryObject);exports.Image=Image;
var Group=function(c){function b(){for(var a=[],b=0;b<arguments.length;b++)a[b-0]=arguments[b];c.call(this);this.group=a}__extends(b,c);b.prototype.name=function(){return"Group"};return b}(UnitaryObject);exports.Group=Group;
